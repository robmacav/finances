class ExpensesController < ApplicationController
  ...
  def expense_params
    params.require(:expense).permit(:description, :expense_category_id, :tag_id, :date, :payment_method, :card_id, items_attributes: [ :id, :quantity, :description, :value, :_destroy ]).merge(user_id: 1)
  end
end
